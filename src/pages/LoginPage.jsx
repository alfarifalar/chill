...
import { Card, CardBody, CardHeader, Image,Form, Input } from '@heroui/react'
      ...
      <Card className='w-full sm:w-132.25 rounded-lg gap-5 p-6 sm:gap-9 sm:p-10 bg-[oklch(21.545%_0.00607_236.988/0.84)]'>
        <CardHeader className='flex flex-col items-center justify-center gap-5 sm:gap-9 p-0'>
          ...
          <div className='text-center text-light'>
            <h1 className='font-bold text-lg sm:text-[32px]'>Masuk</h1>
            <p className='text-[10px] sm:text-base'>Selamat datang kembali!</p>
          </div>
        </CardHeader>
            ...
            <div className='flex flex-col w-full'>
              ...
              <div className='flex justify-between mt-2 sm:mt-3'>
                <span className='text-light-secondary text-[10px] sm:text-base'>
                  Belum punya akun? <Link to="/register" className='decoration-0 text-light text-[10px] sm:text-base'>Daftar</Link>
                </span>
                <span className='text-light text-[10px] sm:text-base'>Lupa kata sandi?</span>
              </div>
            </div>
            <div className='flex flex-col w-full gap-1 sm:gap-2'>
              <button className='bg-extra text-light text-[10px] sm:text-base font-medium py-2 sm:py-3 px-3 sm:px-5 border border-outline rounded-[14px] sm:rounded-3xl' type='submit'>Masuk</button>
